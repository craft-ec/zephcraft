...
**By cost:** capabilities K2–K4 cheapest (host fns over in-tree crypto); wire K5–K8 medium (K7 generalizes K5/K6); substrate K1/K9/K10 deepest. K9 + K10 done; K1 config-half done. Once the K1 anchor half lands (if a governed-WASM program appears), reputation/tracking/catalog/app-store are pure protocol-program work.
